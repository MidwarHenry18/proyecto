...
import com.example.appinmueble.component.*
import com.example.appinmueble.fragment.CategoriesFragment
import com.example.appinmueble.fragment.CompaniesFragment
import com.example.appinmueble.fragment.OrderCardFragment
import com.example.appinmueble.fragment.ProfileFragment
    ...
    Scaffold(backgroundColor = MaterialTheme.colors.background,
        ...
        topBar ={
            Crossfade(targetState = section.value) { section ->
                when (section) {
                    Section.Companies ->
                        TopBarApp("Venta de Inmuebles","Busca tu mejor opcion",R.drawable.ic_baseline_lightbulb_24, onIconClick = {toggleTheme()})
                    Section.Explore ->
                        TopBarApp("Categorias","Categorias principales",R.drawable.ic_baseline_search_24, onIconClick = {})
                    Section.Orders ->
                        TopBarApp("Publicar","Tus Publicaciones",R.drawable.ic_baseline_filter_list_24, onIconClick = {})
                    Section.Profile ->
